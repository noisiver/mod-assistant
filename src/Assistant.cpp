...
class Assistant : public CreatureScript
{
    public:
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
        {
            ...
            {
                ClearGossipMenuFor(player);
                AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want to change my name", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_UTILITIES+1, "Do you wish to continue the transaction?", (sConfigMgr->GetOption<int32>("Assistant.Utilities.NameChange", 10) * 10000), false);
                AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want to change my appearance", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_UTILITIES+2, "Do you wish to continue the transaction?", (sConfigMgr->GetOption<int32>("Assistant.Utilities.Customization", 50) * 10000), false);
                AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want to change my race", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_UTILITIES+3, "Do you wish to continue the transaction?", (sConfigMgr->GetOption<int32>("Assistant.Utilities.RaceChange", 500) * 10000), false);
                AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want to change my faction", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_UTILITIES+4, "Do you wish to continue the transaction?", (sConfigMgr->GetOption<int32>("Assistant.Utilities.FactionChange", 1000) * 10000), false);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Previous Page", GOSSIP_SENDER_MAIN, 1);
                SendGossipMenuFor(player, ASSISTANT_GOSSIP_TEXT, creature->GetGUID());
            }
